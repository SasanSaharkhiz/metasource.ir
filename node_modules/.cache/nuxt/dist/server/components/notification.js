...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Notification.vue?vue&type=template&id=74714634&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-snackbar',{attrs:{"timeout":-1,"dark":_vm.$vuetify.theme.dark,"light":!_vm.$vuetify.theme.dark},scopedSlots:_vm._u([{key:"action",fn:function(ref){
var attrs = ref.attrs;
return [_c('v-btn',_vm._b({attrs:{"color":"info","small":""},on:{"click":function($event){_vm.snackbar = false}}},'v-btn',attrs,false),[_vm._v("\n      More info\n    ")]),_vm._v(" "),_c('v-btn',_vm._b({attrs:{"color":"primary ml-3","small":""},on:{"click":function($event){_vm.snackbar = false}}},'v-btn',attrs,false),[_vm._v("\n      Accept\n    ")])]}}]),model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_vm._v("\n  "+_vm._s(_vm.text)+"\n\n  ")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/Notification.vue?vue&type=template&id=74714634&
...
var VSnackbar = __webpack_require__(262);
