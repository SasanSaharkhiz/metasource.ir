...
export default {
  data() {
    return {
      testimonials: [
        {
          avatar: this.$t('index.reviews.comments.comment1.avatar'),
          name: this.$t('index.reviews.comments.comment1.name'),
          post: this.$t('index.reviews.comments.comment1.post'),
          message: this.$t('index.reviews.comments.comment1.message'),
        },
        {
          avatar: this.$t('index.reviews.comments.comment1.avatar'),
          name: this.$t('index.reviews.comments.comment1.name'),
