      ...
      items: [
        {
          ...
          title: this.$t('index.header.menu.home'),
          to: '/',
        },
        {
          icon: 'mdi-account',
          title: this.$t('index.header.menu.about'),
          to: '/about',
        },
        {
          icon: 'mdi-tools',
          title: this.$t('index.header.menu.services'),
          to: '/services',
          submenu: [
            {
              title: this.$t('index.header.menu.service_items.blockchain'),
              to: '/services',
            },
            {
              title: this.$t('index.header.menu.service_items.platform'),
              to: '/#',
            },
            {
              title: this.$t('index.header.menu.service_items.website'),
              to: '/#',
            },
            {
              title: this.$t('index.header.menu.service_items.mobile_app'),
              to: '/#',
            },
          ],
        },
        {
          ...
          title: this.$t('index.header.menu.project'),
          to: '/gallery',
        },
        {
          icon: 'mdi-blogger',
          title: this.$t('index.header.menu.blog'),
          to: '/blog',
        },
        {
          icon: 'mdi-contacts',
          title: this.$t('index.header.menu.contact'),
          to: '/contact',
        },
      ],
    }
